...
export default function ToolInventory() {
  ...
  // Baking tools
  const bakingTools = [
    { id: 201, name: 'DINNER PLATE', category: 'baking', quantity: 0, unit: 'POS', remarks: '', lastChecked: '2026-02-23' },
    { id: 202, name: 'FORK', category: 'baking', quantity: 0, unit: 'PS', remarks: '', lastChecked: '2026-02-23' },
    { id: 203, name: 'SPOON', category: 'baking', quantity: 0, unit: 'PES', remarks: '', lastChecked: '2026-02-23' },
    { id: 204, name: 'VOLUME CUP', category: 'baking', quantity: 0, unit: 'PC', remarks: '', lastChecked: '2026-02-23' },
    { id: 205, name: 'UTILITY BOWL', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 206, name: 'MIXING BOWL', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 207, name: 'COOLING RACK', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 208, name: 'CUTTING BOARD', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 209, name: 'PCCRATER', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 210, name: 'WHISK', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 211, name: 'MEASURING RING SPOON', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 212, name: 'STRAIGHT METAL SPATULA', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 213, name: 'UTILITY TRAY', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 214, name: 'RUBBER SPATULA', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
    { id: 215, name: 'WOODEN SPOON', category: 'baking', quantity: 0, unit: 'PCS', remarks: '', lastChecked: '2026-02-23' },
  ];

  const allTools = [...kitchenTools, ...barTools, ...bakingTools];
  ...
  // Requests with approval status
  const [requests, setRequests] = useState<RequestItem[]>([
    { id: 1, name: 'Mixing Bowl', quantity: 5, unit: 'PCS', remarks: 'Stainless steel', date: '2026-02-23', approved: false },
    { id: 2, name: 'Whisk', quantity: 3, unit: 'PCS', remarks: 'Small size', date: '2026-02-22', approved: true },
    { id: 3, name: 'Cutting Board', quantity: 2, unit: 'PCS', remarks: 'Plastic', date: '2026-02-21', approved: false },
  ]);
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                {filteredTools.length === 0 && (
                  <tr>
                    <td colSpan={showSimplifiedColumns ? 5 : 6} className="py-8 text-center text-gray-500">

  ...
  if (isMinimized) {
    return (
      <button
        ...
        title={userName}
      >
        <div className="w-10 h-10 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full flex items-center justify-center text-white font-bold cursor-pointer hover:shadow-lg transition-shadow">
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="w-10 h-10 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full flex items-center justify-center text-white font-bold shadow-md">
          {getInitials(userName)}
        </div>
      </button>
        ...
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-2xl shadow-pink-200/50 border border-gray-200 z-50 overflow-hidden">
          ...
          <div className="px-4 py-4 border-b border-gray-200">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md">
                {getInitials(userName)}
              </div>
              <div>
